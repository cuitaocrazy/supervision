    ...
    <form >
      <div className='fixed left-0 right-0 pb-2 mt-3 bg-white'>
        <div className="flex pt-3 font-mono text-xs ">
          <input type="text" className="flex items-center justify-center h-8 pl-4 ml-3 text-sm text-gray-300 border border-gray-400 shadow-lg rounded-l-3xl grow focus:outline-none focus:glow-primary-600"
