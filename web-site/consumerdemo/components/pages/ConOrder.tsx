...
const ConOrder=()=>{
  ...
  return <IonPage>
    ...
    <IonContent>
        <div className='mb-3 bg-gray-100 pb-14 scroll-auto'>
         
          <div className='mx-3 bg-gray-100'>

                  <div className='pt-3 ml-1 text-base font-bold text-gray-800'>
                    请选择学员
                  </div>
                  <div className='grid items-center grid-cols-2 py-3 pl-2 mt-3 text-base bg-white rounded-lg'>
                   ...
                   {/* 订单信息 */}
                  <div className='pt-1 pb-2 mt-3 mb-3 bg-white rounded-lg'>
