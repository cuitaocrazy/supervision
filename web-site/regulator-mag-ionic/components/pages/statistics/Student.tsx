...
const Subject:React.FC =()=>{
  ...
  useEffect(()=>{
    const returnResult = [{eduName:'A机构',rate:123},{eduName:'B机构',rate:456},{eduName:'C机构',rate:789},{eduName:'其他机构',rate:3}]
    const other = {eduName:'其他',rate:1-returnResult.reduce((pre,cur)=>pre+cur.rate,0)}
  ...
  const pieData = {
    labels: subjects.map(item=>item.eduName),
    datasets: [
      {
        label: '',
