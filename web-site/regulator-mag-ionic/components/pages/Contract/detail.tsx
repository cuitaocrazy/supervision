       ...
       <div className="grid grid-cols-2 justify-items-center ">
         <div className="flex items-center mb-4 leading-10 justify-items-center">
           ...
           <input
             ...
             name="contractId" type="text" value={contractState.contractId}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="contractDate" type="text" value={contractState.contractDate}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="contractTime" type="text" value={contractState.contractTime}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="contractUpdateReason" type="text" value={contractState.contractUpdateReason}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="eduId" type="text" value={contractState.eduId} spellCheck={false}
             readOnly
           />
         </div>
         ...
         <div className="flex mb-4 leading-10">
           ...
           <input className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="eduName" type="text" value={contractState.eduName}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="lessonType" type="text" value={contractState.lessonType}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="lessonName" type="text" value={contractState.lessonName}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="lessonIntroduce" type="text" value={contractState.lessonIntroduce}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
         ...
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="teacherName" type="text" value={contractState.teacherName}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="lessonStartDate" type="text" value={contractState.lessonStartDate}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             ...
             name="lessonStartTime" type="text" value={contractState.lessonStartTime} 
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="lessonEndDate" type="text" value={contractState.lessonEndDate}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="lessonEndTime" type="text" value={contractState.lessonEndTime}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="lessonTotalPrice" type="text" value={contractState.lessonTotalPrice}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="lessonTotalQuantity" type="text" value={contractState.lessonTotalQuantity} 
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="lessonPerPrice" type="text" value={contractState.lessonPerPrice}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="consumerName" type="text" value={contractState.consumerName}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="orderNo" type="text" value={contractState.orderNo}
             readOnly
           />
         </div>
       </div>
