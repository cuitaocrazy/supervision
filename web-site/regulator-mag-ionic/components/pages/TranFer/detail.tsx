       ...
       <div className="grid grid-cols-2 justify-items-center ">
         <div className="flex items-center mb-4 leading-10 justify-items-center">
           ...
           <input
             ...
             name="transferId" type="text" value={state.contractId}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="transferName" type="text" value={state.transfer.transferDetail.eduName}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="transferIdentityNo" type="text"  value={state.transfer.transferDetail.lessonName}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="transferExperience" type="text" value={state.transfer.transferDetail.consumerName}
             readOnly
           />
         </div>
         <div className="flex mb-4 leading-10">
           ...
           <input
             className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="transferIntroduce" type="text" value={state.transfer.transferDetail.transferResult} 
             readOnly
           />
         </div>
         ...
         <div className="flex mb-4 leading-10">
           ...
           <input className="w-64 px-2 rounded-md bg-primary-100 focus:outline-none"
             name="transferRating" type="text" value={state.transfer.transferDetail.transferAmt}
             readOnly
           />
         </div>        
