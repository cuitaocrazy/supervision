...
import { IonPage, IonList, IonLabel, IonItem, IonRow, IonCol, IonDatetime } from '@ionic/react';
import { PickerColumn } from '@ionic/core';

// const queryURL = 'http://localhost:3003/querySum';
// const demoOrderList: TranSum[] = [{ USVOrgID: 'Edu1MSP', TranSumAmt: 100000, TranCount: 10 }];
// const demoUSVList = [
...
//     SubscribeStartDateStart: '',
//     SubscribeStartDateEnd: '',
//     USVOrgID: '',
//     isOpen: false,
//     USVOrgName: '',
//   });
...
//     <div className="">
//       <IonItem key={key}>
//         <IonLabel>{/* <p className='text-center'>{sumInfo.USVOrgID}</p> */}</IonLabel>
//         <IonLabel>
...
//               <IonLabel className="flex h-12 p-2 font-bold text-center text-primary-600 w-36">
//                 交易日期开始：
//               </IonLabel>
//               <IonDatetime
//                 className="flex w-56 h-12 pt-2.5 font-bold text-center text-primary-600 bg-white rounded-md"
//                 value={queryInfo.SubscribeStartDateStart}
//                 name="SubscribeStartDateStart"
...
//               <IonDatetime
//                 className="flex w-56 h-12 pt-2.5 font-bold text-center text-primary-600 bg-white rounded-md"
//                 value={queryInfo.SubscribeStartDateEnd}
//                 name="SubscribeStartDateEnd"
//                 displayFormat="YYYYMMDD"
//                 onIonChange={e => {
//                   setQueryInfo({ ...queryInfo, ...{ SubscribeStartDate: e.detail.value! } });
//                 }}
...
// };
const FianceTranSumQuery: React.FC = () => {
  return <IonPage>regulator-mag-ionic/components/pages/FianceTranSumQuery.tsx 未完成</IonPage>;
};
