...
const ShoppingCar: FC<CarProps> = (props) => {
  ...
  return <div className="flex justify-center">
    <div className="flex flex-row w-1/2 mb-5 bg-white border border-gray-200 rounded-lg shadow-md">
     <div className="ml-2">
      ...
      <div className="flex flex-col">
        <div className="h-10 px-3 py-2 truncate text-primary-600">{props.title}</div>
