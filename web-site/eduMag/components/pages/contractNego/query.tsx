...
import { eduContractNegoFindURL } from "const/consts";
      ...
      <td className="flex items-center justify-center leading-10">
        <div className="flex gap-2 ">
          ...
          <button
            ...
            hidden={contractNego.negoEduAgree == true}
          >
            审核
          </button>
      ...
      <div className="relative w-full h-screen mx-6 overflow-auto">
        <div className="flex pt-2 my-2 text-gray-800">
          ...
          <div>
            ...
            <span className="px-1 text-gray-600">退课管理</span>/
            <span className="pl-1 text-primary-500">列表</span>
          </div>
        </div>
          ...
          <table className="w-11/12">
            ...
            <tbody>
              {state.contractNego?.contractNegoList.map(
                (contractNego: ContractNego, i: any) => (
