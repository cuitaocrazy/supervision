    ...
    <IonPage className='bg-gray-100'>
      <IonCard>
        ...
        <div className='flex px-2 pt-2 mx-2 my-2 text-gray-800'>
          ...
          <div>
            <span className='pr-1 text-gray-600 '>课程管理</span>/<span className='pl-1 text-primary-500'>课程编辑</span>
          </div>
        </div>
        <IonCardContent>
          <form onSubmit={onModify}>
            ...
            <div className='grid grid-cols-2 justify-items-center '>
              <div className='flex items-center mb-4 leading-10 justify-items-center'>
                ...
                <input type="text" className='w-64 px-2 border rounded-md' onChange={e => setLessonState({ ...lessonState, lessonName: e.nativeEvent.target?.value })} value={lessonState.lessonName} required />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>总课时:</div>
                <input className='w-64 px-2 border rounded-md' type="text" onChange={e => setLessonState({ ...lessonState, lessonTotalQuantity: e.nativeEvent.target?.value })} value={lessonState.lessonTotalQuantity} required />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>总价格（元）:</div>
                <input className='w-64 px-2 border rounded-md' type="text" onChange={e => setLessonState({ ...lessonState, lessonTotalPrice: e.nativeEvent.target?.value })}  value={lessonState.lessonTotalPrice} required />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>课程单价（元）:</div>
                <input className='w-64 px-2 border rounded-md' type="text" onChange={e => setLessonState({ ...lessonState, lessonPerPrice: e.nativeEvent.target?.value })}  value={lessonState.lessonPerPrice} required />
              </div>
              <div className='flex mb-4 leading-10'>
              ...
              <div className='flex mb-4 leading-10'>
                ...
                <a className='w-64' href="www.baidu.com" >点击查看课程大纲</a>
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>课程开始日期:</div>
                <input className='w-64 px-2 border rounded-md' onChange={e => setLessonState({ ...lessonState, lessonStartDate: e.nativeEvent.target?.value })} required value={lessonState.lessonStartDate} />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>课程开始时间:</div>
                <input className='w-64 px-2 border rounded-md' onChange={e => setLessonState({ ...lessonState, lessonStartTime: e.nativeEvent.target?.value })} required value={lessonState.lessonStartTime} />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>课程结束日期:</div>
                <input className='w-64 px-2 border rounded-md' onChange={e => setLessonState({ ...lessonState, lessonEndDate: e.nativeEvent.target?.value })} required value={lessonState.lessonEndDate} />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>课程结束时间:</div>
                <input className='w-64 px-2 border rounded-md' onChange={e => setLessonState({ ...lessonState, lessonEndTime: e.nativeEvent.target?.value })} required value={lessonState.lessonEndTime} />
              </div>
              <div className='flex mb-4 leading-10'>
              ...
              <div className='flex mb-4 leading-10'>
                ...
                <input className='w-64 px-2 border rounded-md' type="text" onChange={e => setLessonState({ ...lessonState, ...{'edu':{...lessonState.edu,eduName:e.nativeEvent.target?.value }}    })} required value={lessonState.edu.eduName} />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>教师姓名:</div>
                <input className='w-64 h-10 px-2 border rounded-md' type="text" onChange={e => setLessonState({ ...lessonState, ...{'teacher':{...lessonState.teacher,teacherName:e.nativeEvent.target?.value }}  })} required value={lessonState.teacher.teacherName} />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>课程介绍:</div>
                <input className='w-64 h-32 px-2 border rounded-md' type="text" onChange={e => setLessonState({ ...lessonState, lessonIntroduce: e.nativeEvent.target?.value })} required value={lessonState.lessonIntroduce} />
              </div>
            </div>
          </form>
