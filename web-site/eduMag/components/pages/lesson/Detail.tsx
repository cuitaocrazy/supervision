    ...
    <IonPage>
      <IonCard>
        ...
        <div className='flex px-2 pt-2 mx-2 my-2 text-gray-800'>
          ...
          <div>
            <span className='pr-1 text-gray-600 '>课程管理</span>/<span className='pl-1 text-primary-500'>课程详情</span>
          </div>
        </div>
        <IonCardContent>
          <form onSubmit={onModify}>
            ...
            <div className='grid grid-cols-2 justify-items-center '>
              <div className='flex items-center mb-4 leading-10 justify-items-center'>
                ...
                <input className='w-64 px-2 rounded-md bg-primary-100 focus:outline-none' value={lessonState.lessonName} readOnly />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>总课时:</div>
                <input className='w-64 px-2 rounded-md bg-primary-100 focus:outline-none' value={lessonState.lessonTotalQuantity} readOnly />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>总价格（元）:</div>
                <input className='w-64 px-2 rounded-md bg-primary-100 focus:outline-none' value={lessonState.lessonTotalPrice} readOnly />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>课程单价（元）:</div>
                <input className='w-64 px-2 rounded-md bg-primary-100 focus:outline-none' value={lessonState.lessonPerPrice} readOnly />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>课程类型:</div>
                <input className='w-64 px-2 rounded-md bg-primary-100 focus:outline-none' value={lessonState.lessonType} readOnly />
              </div>
              ...
              <div className='flex mb-4 leading-10'>
                ...
                <input className='w-64 px-2 rounded-md bg-primary-100 focus:outline-none' value={lessonState.lessonStartDate} readOnly />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>课程开始时间:</div>
                <input className='w-64 px-2 rounded-md bg-primary-100 focus:outline-none' value={lessonState.lessonStartTime} readOnly />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>课程结束日期:</div>
                <input className='w-64 px-2 rounded-md bg-primary-100 focus:outline-none' value={lessonState.lessonEndDate} readOnly />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>课程结束时间:</div>
                <input className='w-64 px-2 rounded-md bg-primary-100 focus:outline-none' value={lessonState.lessonEndTime} readOnly />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>课程状态:</div>
                <input className='w-64 px-2 rounded-md bg-primary-100 focus:outline-none' value={lessonState.lessonState} readOnly />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'> 教育机构名称:</div>
                <input className='w-64 px-2 rounded-md bg-primary-100 focus:outline-none' value={lessonState.edu.eduName} readOnly />
              </div>
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>教师姓名:</div>
                <input className='w-64 h-10 px-2 rounded-md bg-primary-100 focus:outline-none' value={lessonState.teacher.teacherName} readOnly />
              </div> 
              <div className='flex mb-4 leading-10'>
                <div className='flex justify-end w-32 mr-2'>课程介绍:</div>
                <textarea  className='w-64 h-32 px-2 rounded-md bg-primary-100 focus:outline-none' value={lessonState.lessonIntroduce} readOnly />
              </div>
            </div>
          </form>
