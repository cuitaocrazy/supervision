        ...
        <div className="bg-white">
          <div className="flex flex-col items-center justify-center mx-2 my-2 rounded-lg shadow-lg">
            ...
            <div className="flex flex-col mt-2 mb-6 space-y-2">
              <div className="flex">
                <span className="mr-2 text-right text-gray-400">交易时间</span>
                <span className="mr-2 text-gray-800">2022年8月18日</span>
                <span className="text-gray-800">19:28:19</span>
              </div>
              <div className="flex">
                <span className="mr-2 text-right text-gray-400">交易金额</span>
                <span className="mr-2 text-gray-800">198元</span>
              </div>
              <div className="flex">
                <span className="mr-2 text-right text-gray-400">交易类型</span>
                <span className="mr-2 text-gray-800">消费</span>
              </div>
              <div className="flex">
                <span className="mr-2 text-right text-gray-400">交易状态</span>
                <span className="mr-2 text-gray-800">成功</span>
              </div>
              <div className="flex">
                <span className="mr-2 text-right text-gray-400">商户名称</span>
                <span className="mr-2 text-gray-800">黑马程序员培训机构</span>
              </div>
              <div className="flex">
                <span className="mr-2 text-right text-gray-400">权益变化</span>
                <span className="mr-2 text-gray-800">剩余32课时</span>
              </div>
              <div className="flex">
                <span className="w-16 mr-2 text-right text-gray-400">卡名称</span>
                <span className="mr-2 text-gray-800 justify-self-start">前端进阶班</span>
              </div>
              <div className="flex">
                <span className="w-16 mr-2 text-right text-gray-400">卡号</span>
